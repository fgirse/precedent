  ...
  return (
    <div className="relative">
      ...
      <Container className="styles.yfooter">
        ...
        <div className="bg-stone-700 px-3 grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
            ...
            <div>
              ...
              <Link href="/" className="flex items-center space-x-2 text-sm font-medium text-gray-700 dark:text-gray-100">
                    <Image
                      ...
                      width="120"
                      height="60"
                      className="ml-2 w-28 h-12 lg:w-36 border"
                    />
...
/workspaces/precedent/components/shared
